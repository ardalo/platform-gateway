...
public class PlatformGatewayApplication {
  ...
  /**
   * Copy of {@link org.springframework.cloud.gateway.config.GatewayAutoConfiguration.GatewayActuatorConfiguration#gatewayControllerEndpoint(List, List, List, RouteDefinitionWriter, RouteLocator)} gatewayControllerEndpoint}.
   *
